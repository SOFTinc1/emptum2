...
import { SignupContainer, ShowIcon, HideIcon, ButtonsBarContainer} from './sign-up.styles';
    ...
    render() {
        ...
        <SignupContainer>
          <form className='sign-up-form' onSubmit={this.handleSubmit}>
            ...
            <FormInput type={this.state.showPassword ? 'text' : 'password'} name='password' value={password}  onChange={this.handleChange} label='Password' required />
